 ...
 */
final class Version20220117134702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD type VARCHAR(255) NOT NULL, ADD average_value VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP type, DROP average_value');
    }
}
